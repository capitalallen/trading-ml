"""
Gather the orders from all the trading strategies and 
to communicate this order with the market 
- a safeguard against mistakes introduced in trading strategies 
- first, check the validity of the orders 
- second, keep track of the overall postiions and PnL 
